...
export const STATUS_STYLES = {
  ...
  'Initial contact made':  { bg: '#E8F0FF', text: '#1A3A8F', border: '#B3C8F5' },
  'Closed not proceeding': { bg: '#ECEFF1', text: '#455A64', border: '#B0BEC5' },
...
export const STAGE_BORDER_COLORS = {
  'New lead':              '#B3C8F5',
  'Initial contact made':  '#93C5FD',
  'Contacted':             '#60866C',
  'Meeting booked':        '#CE93D8',
  'Proposal sent':         '#FFD54F',
  'Follow up':             '#80DEEA',
  'Closed won':            '#ADCCB7',
  'Closed not proceeding': '#B0BEC5',
}
