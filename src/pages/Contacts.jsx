        ...
        <div style={{ position: 'relative' }}>
          ...
          <input
            ...
            style={{
              ...
              outline: 'none', width: 240, background: '#fff',
            }}
          />
        </div>
              ...
              {filtered.map((c, i) => (
                ...
                >
                  <td style={{ padding: '11px 14px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      ...
                      <div>
                        ...
                        {c.company && (
                          <div style={{ fontSize: 11, color: '#4A6352', fontFamily: 'Poppins, sans-serif' }}>{c.company}</div>
                        )}
                      </div>
                    </div>
                  </td>
                  ...
                  <td style={{ padding: '11px 14px', fontSize: 12, color: '#4A6352', fontFamily: 'Poppins, sans-serif' }}>
                    {c.last_contacted ? fmtDateFull(c.last_contacted) : '—'}
                  </td>
                  <td style={{ padding: '11px 14px', fontSize: 12, fontFamily: 'Poppins, sans-serif' }}>
                    {c.next_followup ? (
                      <span style={{
                        color: isOverdue(c.next_followup) ? '#A32D2D' : isDueSoon(c.next_followup) ? '#92400E' : '#4A6352',
                        fontWeight: isOverdue(c.next_followup) ? 600 : 400,
                      }}>
